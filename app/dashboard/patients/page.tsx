...
export default function PatientsPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.address_barangay.trim()) newErrors.address_barangay = 'Barangay is required';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#3B6255] focus:border-transparent outline-none transition text-gray-800 placeholder-gray-500 bg-white ${
                      errors.address_barangay ? 'border-red-500 bg-red-50' : 'border-gray-300'
                    }`}
                    placeholder="Enter barangay"
                  />
                  {errors.address_barangay && <p className="text-red-500 text-sm mt-1">{errors.address_barangay}</p>}
                </div>
            ...
            <tbody>
              {patients.map((patient) => (
                ...
                >
                  ...
                  <td className="py-4 px-8">
                    <button className="text-[#3B6255] hover:text-[#5A7669] font-semibold text-sm flex items-center gap-1">
